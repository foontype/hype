...
echo "Running: hype helmfile -f nginx-helmfile.yaml -e dev diff"
echo ""
# Note: This will create ConfigMaps but show what would be deployed
DEBUG=1 ../src/hype helmfile -f nginx-helmfile.yaml -e dev diff
echo ""
...
echo "  hype helmfile -f nginx-helmfile.yaml -e dev apply"
echo ""
echo "This would:"
